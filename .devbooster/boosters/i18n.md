...
- **Existing-code i18n audit:** run `python .devbooster/hub/scripts/i18n_checker.py .`.
- Use the output to locate hardcoded strings and locale key mismatches before reading or changing the affected files.
- Do not run it for copy-only changes that do not affect localized code or locale files.

...
VERIFICATION_SUITE = [
    ...
    # P4: UX & Accessibility
    {
        ...
        "checks": [
            ...
            (
                "Accessibility Check",
                ".devbooster/hub/scripts/accessibility_checker.py",
                False,
            ),
        ],
    },
...
Examples:
  ...
  python scripts/verify_all.py . --url https://staging.example.com --no-e2e
    ...
    parser.add_argument(
        ...
        required=False,
        default=None,
        help="URL for performance & E2E checks (optional: Lighthouse/Playwright skipped when omitted)",
    )
    ...
    print(f"URL: {args.url or 'not provided (P6/P7 skipped)'}")

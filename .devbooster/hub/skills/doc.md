...
| ------------- | --------------------------------- | ------------------------------------ |
| **Workspace** | `<workspace-root>/.devbooster/hub/skills/` | Available only in a specific project |
...
```bash
mkdir -p .devbooster/hub/skills/code-review
```
...
```bash
mkdir -p .devbooster/hub/skills/license-header-adder/resources
```

### Step 2: Create the template file

**`.devbooster/hub/skills/license-header-adder/resources/HEADER.txt`**:
...
**`.devbooster/hub/skills/license-header-adder/SKILL.md`**:

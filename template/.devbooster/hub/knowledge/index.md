...
| [`architecture-audit-principles.md`](./architecture-audit-principles.md)   | Multi-stack                         | Convention precedence, evidence, confidence, recommendation discipline, false-positive controls                |
| [`code-duplication-patterns.md`](./code-duplication-patterns.md)           | Multi-stack                         | Duplicate functions, helpers, business logic, components, consolidation confidence                             |
| [`types-contracts-organization.md`](./types-contracts-organization.md)     | TypeScript, multi-stack             | Shared interfaces, types, enums, DTO/domain/UI contract boundaries, terminology                                |
| [`project-structure-patterns.md`](./project-structure-patterns.md)         | Multi-stack                         | Feature, layer, domain, Atomic Design, Clean Architecture, file placement, shared ownership                    |
| [`module-boundaries-dependencies.md`](./module-boundaries-dependencies.md) | Multi-stack                         | Circular imports, module boundaries, orphan files and exports, public/internal boundaries                      |
| [`naming-responsibility-patterns.md`](./naming-responsibility-patterns.md) | Multi-stack                         | Naming clarity, generic names, mixed responsibilities, oversized modules, terminology consistency              |

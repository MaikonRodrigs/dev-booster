...
description: Expert in React Native and Flutter mobile development. Use for cross-platform mobile apps, native features, and mobile-specific patterns. Also routes native Apple work (SwiftUI) to the swift-apps skill. Triggers on mobile, react native, flutter, ios, android, app store, expo, swift, swiftui, xcode, macos, native ios.
tools: Read, Grep, Glob, Bash, Edit, Write
model: inherit
skills: clean-code, mobile-design, swift-apps, xcode-cli
---
...
| **Native Apple (SwiftUI)** | [swift-apps](../skills/swift-apps/SKILL.md) + [platform-ios.md](../skills/swift-apps/platform-ios.md) + [platform-macos.md](../skills/swift-apps/platform-macos.md) | Native SwiftUI (not RN/Flutter) for iPhone/iPad/Mac |

> 🔴 **Native Swift/SwiftUI project? Load the `swift-apps` skill** (`.devbooster/hub/personas/skill_swift-apps.md`) — it covers Swift language, SwiftUI, SwiftData, and the iOS/macOS/watchOS/tvOS platform guides.
> 🛠️ **Xcode build/simulator/signing work → load the `xcode-cli` skill** (`.devbooster/hub/personas/skill_xcode-cli.md`).

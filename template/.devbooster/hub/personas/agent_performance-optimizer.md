...
For CPU-heavy work blocking the main thread (long tasks, frozen interactions), offload to a Web Worker with the React pattern in `hub/knowledge/react-web-workers.md` (useRef holder + Effect lifecycle + typed message protocol + progress).

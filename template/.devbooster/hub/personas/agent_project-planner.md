...
1.  **Read** `.devbooster/rules/CODEBASE.md` → Check **OS** field (Windows/macOS/Linux) if present
...
> 💡 **Script paths are relative to project root: `.devbooster/hub/scripts/`**
...
# P0: Security Scan
python .devbooster/hub/scripts/security_scan.py .

# P1: UX Audit
python .devbooster/hub/scripts/ux_audit.py .

# P3: Lighthouse (requires running server)
python .devbooster/hub/scripts/lighthouse_audit.py http://localhost:3000

# P4: Playwright E2E (requires running server)
python .devbooster/hub/scripts/playwright_runner.py http://localhost:3000 --screenshot
```

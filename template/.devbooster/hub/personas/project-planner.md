...
> 💡 **Script paths are relative to `.devbooster/` directory**

#### 1. Run All Verifications (RECOMMENDED)

```bash
# SINGLE COMMAND - Runs all checks in priority order:
python .devbooster/hub/scripts/verify_all.py . --url http://localhost:3000
...
# P0: Security Scan
python .devbooster/hub/skills/vulnerability-scanner/scripts/security_scan.py .

# P1: UX Audit
python .devbooster/hub/skills/frontend-design/scripts/ux_audit.py .

# P3: Lighthouse (requires running server)
python .devbooster/hub/skills/performance-profiling/scripts/lighthouse_audit.py http://localhost:3000

# P4: Playwright E2E (requires running server)
python .devbooster/hub/skills/webapp-testing/scripts/playwright_runner.py http://localhost:3000 --screenshot
```

...
| ------------- | --------------------------------- | ------------------------------------ |
| **Workspace** | `<workspace-root>/.zed/prompts/skill_` | Available only in a specific project |
...
```bash
mkdir -p .zed/prompts/skill_code-review
```
...
```bash
mkdir -p .zed/prompts/skill_license-header-adder/resources
```

### Step 2: Create the template file

**`.zed/prompts/skill_license-header-adder/resources/HEADER.txt`**:
...
**`.zed/prompts/skill_license-header-adder/SKILL.md`**:

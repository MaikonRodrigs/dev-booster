...
| ---------------------- | ------------------- | ------------------------------------------------------------------------- |
| `playwright_runner.py` | Basic browser test  | `python .devbooster/hub/scripts/playwright_runner.py https://example.com` |
|                        | With screenshot     | `python .devbooster/hub/scripts/playwright_runner.py <url> --screenshot`  |
|                        | Accessibility check | `python .devbooster/hub/scripts/playwright_runner.py <url> --a11y`        |
